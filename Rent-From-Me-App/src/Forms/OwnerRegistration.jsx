...
function OwnerRegistration() {
  ...
  return (
    <div className="bg-white flex justify-center items-center mt-24 lg:w-[60%] mx-auto">
      ...
      >
        <Form className="bg-white p-8 shadow-md rounded-sm">
          <div className="mb-2 text-center flex justify-center ">
            <label className="block mb-2 text-3xl font-bold text-blue-700 lg:text-4xl dark:text-white">Registration</label>
          </div>
          ...
          <button type="submit" className="text-white w-full mt-3 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium text-lg px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Register</button>
        </Form>
      </Formik>
    </div>
  )
