...
message()
  ...
  return (
    ...
    <ErrorMessage className='text-red-500 py-3' component='div' name="title"  />
     ...
     <div className='mb-4 relative'>
<Field className = 'h-[50px] w-full   text-lg border-2 outline-0 tracking-wider p-1' type="text" id="first_name" name = 'make' placeholder=' Make' />

<ErrorMessage className='text-red-500 py-3' component='div' name="make"  />
 </div>
 <div className='mb-4 relative'>
<Field className = 'h-[50px] w-full  text-lg border-2 outline-0 tracking-wider p-1' type="text" id="first_name" name = 'model' placeholder=' Model' />
...
<Field className = ' h-[50px] w-full text-lg border-2 outline-0   tracking-wider p-1' type="number" id="first_name" name = 'daily_cost' placeholder='Daily Cost' />

<ErrorMessage  className='text-red-500 mt-3' component='div' name="daily_cost"  />
 </div>
 <div className='mb-4 relative'>
<Field className = ' h-[50px] w-full text-lg border-2 outline-0    tracking-wider p-1' type="text" id="first_name" name = 'condition' placeholder=' condition' />

<ErrorMessage  className='text-red-500 mt-3' component='div' name="condition"  />
 </div>
 <div className='mb-4 relative'>
<Field className = ' h-[80px] w-full  text-lg border-2  outline-0   tracking-wider p-1' type="text" id="first_name" name = 'description' placeholder=' Description' />
